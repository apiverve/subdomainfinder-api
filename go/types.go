// Package subdomainfinder provides a Go client for the Subdomain Finder API.
//
// For more information, visit: https://subdomainfinder.apiverve.com?utm_source=go&utm_medium=readme
...
// Request contains the parameters for the Subdomain Finder API.
//
// Parameters:
//   - domain (required): string - The domain you want to find all the available subdomains for (e.g. google.com)
//   - limit: integer - Limit the number of subdomains to detect [min: 1, max: 500]
type Request struct {
...
func (r *Request) Validate() error {
	rules := map[string]ValidationRule{
		...
		"limit": {Type: "integer", Required: false, Min: float64Ptr(1), Max: float64Ptr(500)},
	}
...
// ResponseData contains the data returned by the Subdomain Finder API.
type ResponseData struct {
	Count int `json:"count"`
	RootDomain RootDomainData `json:"rootDomain"`
	SubDomains []SubDomainsItem `json:"subDomains"`
}

// RootDomainData represents the rootDomain object.
type RootDomainData struct {
	Domain string `json:"domain"`
	Records []string `json:"records"`
}

// SubDomainsItem represents an item in the SubDomains array.
type SubDomainsItem struct {
