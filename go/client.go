...
const (
	baseURL        = "https://api.apiverve.com/v1/subdomainfinder"
	defaultTimeout = 30 * time.Second
)

// Client is the Subdomain Finder API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Subdomain Finder API client.
...
// Execute makes a request to the Subdomain Finder API with typed parameters.
//
