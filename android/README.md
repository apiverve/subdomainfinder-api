...
```gradle
dependencies {
    implementation 'com.github.apiverve:subdomainfinder-api:1.1.12'
}
```
...
```java
import com.apiverve.subdomainfinder.SubdomainFinderAPIClient;
import com.apiverve.subdomainfinder.APIResponse;
import com.apiverve.subdomainfinder.APIException;

// Initialize the client
SubdomainFinderAPIClient client = new SubdomainFinderAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/subdomainfinder](https://docs.apiverve.com/ref/subdomainfinder)
...
- **Documentation:** [https://docs.apiverve.com/ref/subdomainfinder](https://docs.apiverve.com/ref/subdomainfinder)
- **Issues:** [GitHub Issues](https://github.com/apiverve/subdomainfinder-api/issues)
