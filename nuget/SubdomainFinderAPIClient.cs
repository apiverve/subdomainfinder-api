...
namespace APIVerve.API.SubdomainFinder
{
    ...
    /// <summary>
    /// Client for the SubdomainFinder API
    /// </summary>
    public class SubdomainFinderAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/subdomainfinder";
        ...
        private static readonly Dictionary<string, ValidationRule> _validationRules = new Dictionary<string, ValidationRule>
        {
            ...
            { "limit", new ValidationRule { Type = "integer", Required = false, Min = 1, Max = 500 } }
        };
        ...
        public SubdomainFinderAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public SubdomainFinderAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public SubdomainFinderAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, SubdomainFinderQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(SubdomainFinderQueryOptions options)
        {
        ...
        public ResponseObj Execute(SubdomainFinderQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(SubdomainFinderQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(SubdomainFinderQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(SubdomainFinderQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(SubdomainFinderQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(SubdomainFinderQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(SubdomainFinderQueryOptions options)
        {
