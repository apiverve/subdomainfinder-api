...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/subdomainfinder',
        'Source': 'https://github.com/apiverve/subdomainfinder-api',
        'Bug Tracker': 'https://github.com/apiverve/subdomainfinder-api/issues'
    },
    classifiers=[
